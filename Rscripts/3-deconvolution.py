...
# Load data
st_count = sc.read_csv(proj_dir + "retina_st.csv").T
st_count.obs_names = st_count.obs_names.str.replace("\\.1", "-1")
sc_count = sc.read_csv(proj_dir + "retina_sc.csv").T
sc_count.obs_names = sc_count.obs_names.str.replace("\\.1", "-1")
sc_meta = pd.read_csv(proj_dir + "retina_sc_meta.csv", index_col=0)
st_meta = pd.read_csv(proj_dir + "retina_st_meta.csv", index_col=0)
